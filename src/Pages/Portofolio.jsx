...
export default function FullWidthTabs() {
  ...
  useEffect(() => {
    ...
    // Store static data in localStorage for About component
  ...
  return (
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#030014] overflow-hidden" id="Portofolio">
      ...
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        <h2 className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-gray-300 to-white">
          <span style={{
            color: '#f3f4f6',
            backgroundImage: 'linear-gradient(45deg, #d1d5db 10%, #f3f4f6 93%)',
